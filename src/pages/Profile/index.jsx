            ...
            <div className="h-full overflow-x-hidden bg-gray-200 p-8">
                    <div className="bg-white rounded-lg shadow-xl pb-8">
                        {/* <div x-data="{ openSettings: false }" className="absolute right-12 mt-4 rounded">
                            ...
                            <div x-show="openSettings" className="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl" className="display: none;">
                    ...
                    <div className="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                        ...
                        {/* <div className=" w-full 2xl:w-2/3">
                            ...
                            <div className="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                                <h4 className="text-xl text-gray-900 font-bold">Tour Has Been Booked</h4>
                                ...
                                <div className="mt-4">
                                    <canvas id="verticalBarChart" className="display: block; box-sizing: border-box; height: 414px; width: 828px;" width="1656" height="828"></canvas>
                                </div>
                            </div>
                        </div> */}
                    </div>
